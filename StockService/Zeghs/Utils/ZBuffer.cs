...
namespace Zeghs.Utils {
	...
	public class ZBuffer {
		...
		public bool Add(DateTime time) {
			int iDate = time.Year * 10000 + time.Month * 100 + time.Day;
			int iTime = time.Hour * 3600 + time.Minute * 60 + time.Second;
			bool bDate = this.Add(iDate);
			bool bTime = this.Add(iTime);
			return bDate & bTime;
		}
